...
SOURCES = (
    ...
    "analysis/strategy_5scr_v3/episode_hash.py",
    "storage/strategy_5scr_lifecycle_v2_repository.py",
    "storage/strategy_5scr_shadow_evidence_v2_repository.py",
    "services/pressure_outbox/activity_delivery_transport.py",
    "tests/integration/test_activity_delivery_consumer_postgres.py",
