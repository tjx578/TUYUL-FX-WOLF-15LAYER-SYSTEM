...
class HealthProbeRuntime:
    ...
    def __getattr__(self, name: str) -> Any:
        """Preserve read/probe-method callers while exposing explicit ownership."""
    ...
    *,
    ...
    def _run() -> None:
        ...
        try:
            ...
            # Accepted HTTP connections are separate tasks from serve_forever.
            # A stopped listener alone does not prove its loop can be released.
