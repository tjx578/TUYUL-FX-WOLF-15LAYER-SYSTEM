...
def test_migration_graph_records_structure_without_claiming_execution():
    ...
    assert graph["repository_heads"] == ["20260919_01"]
    assert graph["revision_parents"]["20260919_01"] == "20260915_02"
    assert graph["revision_parents"]["20260915_02"] == "20260915_01"
    assert graph["revision_parents"]["20260915_01"] == ("20260908_01", "20260911_01")
    ...
    assert graph["revision_parents"]["20260909_07"] == "20260909_06"
    assert graph["revision_parents"]["20260909_06"] == "20260909_05"
