...
def test_portable_single_symbol_runtime_lineage_is_lossless_and_deterministic() -> None:
...
def test_portable_multi_symbol_stream_matches_sequential_reference() -> None:
