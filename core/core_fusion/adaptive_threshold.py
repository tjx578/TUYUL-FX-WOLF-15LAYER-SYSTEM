...
from ._types import DEFAULT_META_DRIFT_FREEZE, DEFAULT_MIN_INTEGRITY, AdaptiveUpdate
...
class AdaptiveThresholdController:
    ...
    def __init__(
        self, *, meta_drift_freeze: float = DEFAULT_META_DRIFT_FREEZE, min_integrity: float = DEFAULT_MIN_INTEGRITY
    ) -> None:
    ...
    def recompute(self, frpc_data: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        proposed = {
            ...
            "mean_energy": round(me, 6),
            "integrity_index": round(ii, 6),
        }

        self._state = AdaptiveUpdate(
            timestamp=ts,
            meta_drift=md,
            integrity_index=ii,
            mean_energy=me,
