...
_STATIC_GOLDEN_PATTERNS: tuple[GoldenPattern, ...] = (
    ...
    GoldenPattern("LOW_DENSITY_OPEN_LANE_TIMING_BLOCK", "S", "CONTINUATION_TIMING", "GBPCAD/AUDNZD", "low density sustained pressure block signals open lane continuation before expansion", "ENTRY_WATCH_OR_BUY_WATCH", golden_references=("GBPCAD", "AUDNZD")),
...
_STATIC_PAIR_ROLE_MAP: dict[str, dict[str, Any]] = {
    ...
    "CHFJPY": {"default_role": "JPY_CHF_DUAL_BASKET_CROSS", "golden_patterns": ["BASKET_THEME_CONFIRMATION_CONTEXT", "HIGH_DENSITY_ACCELERATION_CONTINUATION", "TIMING_VALID_NOT_FINAL", "JPY_ALIGNMENT_REQUIRED"]},
    "NZDJPY": {"default_role": "JPY_WEAKNESS_NZD_CROSS", "golden_patterns": ["BASKET_THEME_CONFIRMATION_CONTEXT", "TIMING_VALID_NOT_FINAL", "JPY_ALIGNMENT_REQUIRED"]},
    "GBPUSD": {"default_role": "MAJOR_CABLE_CONTEXT", "golden_patterns": ["LOW_DENSITY_OPEN_LANE_TIMING_BLOCK", "TIMING_VALID_NOT_FINAL"]},
    "EURNZD": {"default_role": "NZD_WEAKNESS_EUR_CROSS", "golden_patterns": ["CLEAN_SAME_PAIR_TAKEOVER", "LOW_DENSITY_OPEN_LANE_TIMING_BLOCK", "TIMING_VALID_NOT_FINAL"]},
    "AUDNZD": {"default_role": "ANTIPODEAN_CROSS_RANGE", "golden_patterns": ["LOW_DENSITY_OPEN_LANE_TIMING_BLOCK", "CLEAN_SAME_PAIR_TAKEOVER"]},
    "GBPAUD": {"default_role": "GBP_AUD_VOLATILITY_CROSS", "golden_patterns": ["CLEAN_SAME_PAIR_TAKEOVER", "TIMING_VALID_NOT_FINAL"]},
    "EURGBP": {"default_role": "EUR_GBP_RANGE_CROSS", "golden_patterns": ["LOW_DENSITY_OPEN_LANE_TIMING_BLOCK", "TIMING_VALID_NOT_FINAL"]},
    "AUDUSD": {"default_role": "MAJOR_AUD_CONTEXT", "golden_patterns": ["LOW_DENSITY_OPEN_LANE_TIMING_BLOCK", "TIMING_VALID_NOT_FINAL"]},
    "AUDCHF": {"default_role": "AUD_CHF_DUAL_BASKET_CROSS", "golden_patterns": ["BASKET_THEME_CONFIRMATION_CONTEXT", "TIMING_VALID_NOT_FINAL"]},
}
