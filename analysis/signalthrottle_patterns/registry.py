...
_STATIC_GOLDEN_PATTERNS: tuple[GoldenPattern, ...] = (
    ...
    GoldenPattern("SUPPORTING_EUR_CROSS_NOT_LEADER", "A", "CROSS_THEME_FILTER", "EURNZD", "supporting EUR-cross pressure is reference context only until the pair validates its own price phase and NZD weakness", "WAIT_OWN_PRICE_PHASE_CONFIRMATION", "VALIDATE_NZD_WEAKNESS_AND_LOCAL_STRUCTURE", block_reason="SUPPORTING_EUR_CROSS_NOT_LEADER", golden_references=("EURNZD",), pair_specific_calibration=("SUPPORTING_EUR_CROSS_RADAR", "EURAUD_LEADER_DIVERGENCE", "NOT_PAIR_LOCKED"), applies_to="ALL_EUR_CROSSES_IF_CONDITIONS_MATCH"),
