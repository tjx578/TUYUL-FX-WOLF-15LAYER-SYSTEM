...
def _market_context_snapshot(context: MarketContext | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "base_basket_score": context.base_basket_score,
        "quote_basket_score": context.quote_basket_score,
        "pair_direction_alignment": context.pair_direction_alignment,
        "basket_blockers": context.basket_blockers,
...
def _market_context_for_symbol(
    ...
    *,
    ...
    return MarketContext(
        ...
        base_basket_score=_optional_float(raw.get("base_basket_score")),
        quote_basket_score=_optional_float(raw.get("quote_basket_score")),
        pair_direction_alignment=_optional_float(raw.get("pair_direction_alignment")),
        basket_blockers=_string_list(raw.get("basket_blockers")),
        basket_validation=_dict_value(raw.get("basket_validation")),
