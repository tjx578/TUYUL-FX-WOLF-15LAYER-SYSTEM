"""
Tick processing pipeline — VWAP, OrderFlow, TickBuffer, Redis persistence.

Re-exports CandleBuilder / Candle / Timeframe from ingest/candle_builder.py
(which is the single source of truth for OHLCV construction).
This module adds tick-level enrichment on top: VWAP accumulation,
order-flow delta tracking, and asynchronous Redis candle persistence.
