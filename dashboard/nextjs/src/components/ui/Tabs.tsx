        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              style={{
                background: active
                  ? "linear-gradient(180deg, rgba(200,255,26,0.18), rgba(200,255,26,0.08))"
                  : "#0A0B0D",
                color: active ? "#C8FF1A" : "#A5ADBA",
                border: `1px solid ${active ? "rgba(200,255,26,0.35)" : "#1B1D21"}`,
                borderRadius: 14,
                padding: 14,
                textAlign: "center",
                fontWeight: 800,
                ...
                fontSize: 13,
                boxShadow: active ? "inset 0 0 0 1px rgba(200,255,26,0.06)" : "none",
              }}
            >
