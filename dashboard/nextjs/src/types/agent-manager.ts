// ============================================================
// TUYUL FX Wolf-15 — Agent Manager Type Definitions
// Mirrors: agents/models.py (Phase 2 backend Pydantic models)
// ============================================================
...
export interface AgentItem {
  ...
  created_at: string;
  updated_at: string;
  // Joined runtime data (when returned by GET /agents/{id})
