...
def _notify_execute_signal(contract: dict[str, Any]) -> None:
    ...
    try:
        ...
        TelegramNotifier().on_execute_signal(
            ...
            entry_price=_to_price_float(contract.get("entry_price")),
            stop_loss=_to_price_float(contract.get("stop_loss")),
            take_profit_1=_to_price_float(contract.get("take_profit_1")),
